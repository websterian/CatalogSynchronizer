...
namespace Sitecore.Commerce.Sample.Console
{
    public static class PromotionsUX
    {
        ...
        public static void RunScenarios()
        {
            ...
            System.Console.WriteLine("Begin PromotionsUX");
            ...
            System.Console.WriteLine($"End PromotionsUX :{watch.ElapsedMilliseconds} ms");
        }

        private static void Books()
        {
            System.Console.WriteLine("Begin PromotionBooks View");
        ...
        {
            System.Console.WriteLine("Begin BookMaster View");
        ...
        {
            System.Console.WriteLine("Begin BookDetails View");
        ...
        {
            System.Console.WriteLine("Begin AddPromotionBookUX");
        ...
        {
            System.Console.WriteLine("Begin EditPromotionBookUX");
        ...
        {
            System.Console.WriteLine("Begin Books Promotions View");
        ...
        {
            System.Console.WriteLine("Begin Books Catalogs View");
        ...
        {
            System.Console.WriteLine("Begin PromotionAssociateCatalogUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView("Entity-PromotionBook-AdventureWorksPromotionBook", "PromotionBookCatalogs", "AssociateCatalog", string.Empty));
            view.Should().NotBeNull();
            view.Policies.Should().BeEmpty();
            view.Properties.Should().NotBeEmpty();
            view.ChildViews.Should().BeEmpty();
        ...
        {
            System.Console.WriteLine("Begin PromotionDisassociateCatalogUX");
        ...
        {
            System.Console.WriteLine("Begin PromotionMaster View");
        ...
        {
            System.Console.WriteLine("Begin PromotionPreview View");
        ...
        {
            System.Console.WriteLine("Begin PromotionDetails View");
        ...
        {
            System.Console.WriteLine("Begin ValidateAddPromotionUX");
        ...
        {
            System.Console.WriteLine("Begin EditPromotionUX");
        ...
        {
            System.Console.WriteLine("Begin DeletePromotionUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(_bookId, "Details", string.Empty, string.Empty));
            view.Should().NotBeNull();
        ...
        {
            System.Console.WriteLine("Begin DuplicatePromotionUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "Details", name, string.Empty));
            view.Should().NotBeNull();
            view.Policies.Should().BeEmpty();
            view.Properties.Should().NotBeEmpty();
            view.ChildViews.Should().BeEmpty();
            ...
            view.Properties = new ObservableCollection<ViewProperty>
            {
                new ViewProperty
                {
                    Name = "PromotionDuplicateName",
                    Value = "consoleuxduplicatepromotion"
                },
                version
            };
            var result = Proxy.DoCommand(AuthoringContainer.DoAction(view));
        ...
        {
            System.Console.WriteLine("Begin Qualifications View");
        ...
        {
            System.Console.WriteLine("Begin QualificationDetails View");
        ...
        {
            System.Console.WriteLine("Begin AddQualificationUX");

            var selectView = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "QualificationDetails", "SelectQualification", string.Empty));
            ...
            selectView.Properties = new ObservableCollection<ViewProperty>
            {
                ...
                {
                    Name = "Condition",
                    Value = "CartHasFulfillmentCondition"
                },
                version
            };
            var selectAction = Proxy.DoCommand(AuthoringContainer.DoAction(selectView));
            ...
            var addAction = Proxy.DoCommand(AuthoringContainer.DoAction(addView));
        ...
        {
            System.Console.WriteLine("Begin EditQualificationUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "QualificationDetails", "EditQualification", qualificationId));
            view.Should().NotBeNull();
            view?.Policies.Should().BeEmpty();
            view?.Properties.Should().NotBeEmpty();
            view?.ChildViews.Should().BeEmpty();
        ...
        {
            System.Console.WriteLine("Begin DeleteQualificationUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "QualificationDetails", "DeleteQualification", qualificationId));
            view.Should().NotBeNull();
            view.Policies.Should().BeEmpty();
            view.Properties.Should().NotBeEmpty();
            view.ChildViews.Should().BeEmpty();
        ...
        {
            System.Console.WriteLine("Begin Benefits View");
        ...
        {
            System.Console.WriteLine("Begin BenefitDetails View");
        ...
        {
            System.Console.WriteLine("Begin AddBenefitUX");

            var selectView = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "BenefitDetails", "SelectBenefit", string.Empty));
            selectView.Should().NotBeNull();
            selectView.Policies.Should().BeEmpty();
            selectView.Properties.Should().NotBeEmpty();
            selectView.ChildViews.Should().BeEmpty();
            ...
            selectView.Properties = new ObservableCollection<ViewProperty>
            {
                ...
                {
                    Name = "Action",
                    Value = "CartSubtotalPercentOffAction"
                },
                version
            };
            var selectAction = Proxy.DoCommand(AuthoringContainer.DoAction(selectView));
        ...
        {
            System.Console.WriteLine("Begin EditBenefitUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "BenefitDetails", "EditBenefit", benefitId));
            view.Should().NotBeNull();
            view?.Policies.Should().BeEmpty();
            view?.Properties.Should().NotBeEmpty();
            view?.ChildViews.Should().BeEmpty();
        ...
        {
            System.Console.WriteLine("Begin DeleteBenefitUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "BenefitDetails", "DeleteBenefit", benefitId));
            view.Should().NotBeNull();
            view.Policies.Should().BeEmpty();
            view.Properties.Should().NotBeEmpty();
            view.ChildViews.Should().BeEmpty();
        ...
        {
            System.Console.WriteLine("Begin Items View");
        ...
        {
            System.Console.WriteLine("Begin ItemDetails View");
        ...
        {
            System.Console.WriteLine("Begin AddItemUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "ItemDetails", "AddItem", string.Empty));
            view.Should().NotBeNull();
            view?.Policies.Should().BeEmpty();
            view?.Properties.Should().NotBeEmpty();
            view?.ChildViews.Should().BeEmpty();
        ...
        {
            System.Console.WriteLine("Begin RemoveItemUX");

            var view = Proxy.GetValue(AuthoringContainer.GetEntityView(promotionId, "ItemDetails", "RemoveItem", itemId));
            view.Should().NotBeNull();
            view.Policies.Should().BeEmpty();
            view.Properties.Should().NotBeEmpty();
            view.ChildViews.Should().BeEmpty();
