...
namespace Sitecore.Commerce.Sample.Console
{
    public static class CatalogsUX
    {
        ...
        private static void TryEditCatalogUsingShopsEnvironment(Container container)
        {
        ...
        private static void EditCatalogUsingAuthoringEnvironment(Container container)
        {
            using (new SampleMethodScope())
            {
                System.Console.WriteLine("Begin EditCatalog");
                ...
                view.Properties = new ObservableCollection<ViewProperty>
                {
                    ...
                    {
                        Name = "DisplayName",
                        Value = "Console UX Catalog (updated)"
                    },
                    version
                };
